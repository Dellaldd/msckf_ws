...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/ldd/cvbridge_py/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/ldd/cvbridge_py/devel/.private/image_geometry)
  ...
  set(image_geometry_INSTALL_PREFIX /home/ldd/cvbridge_py/install)
...
if(NOT "/home/ldd/cvbridge_py/src/vision_opencv/image_geometry/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/ldd/cvbridge_py/src/vision_opencv/image_geometry/include;/usr/local/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ldd/cvbridge_py/src/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
    _list_append_unique(image_geometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_geometry;/usr/local/lib/libopencv_calib3d.so.4.5.0;/usr/local/lib/libopencv_core.so.4.5.0;/usr/local/lib/libopencv_dnn.so.4.5.0;/usr/local/lib/libopencv_features2d.so.4.5.0;/usr/local/lib/libopencv_flann.so.4.5.0;/usr/local/lib/libopencv_gapi.so.4.5.0;/usr/local/lib/libopencv_highgui.so.4.5.0;/usr/local/lib/libopencv_imgcodecs.so.4.5.0;/usr/local/lib/libopencv_imgproc.so.4.5.0;/usr/local/lib/libopencv_ml.so.4.5.0;/usr/local/lib/libopencv_objdetect.so.4.5.0;/usr/local/lib/libopencv_photo.so.4.5.0;/usr/local/lib/libopencv_stitching.so.4.5.0;/usr/local/lib/libopencv_video.so.4.5.0;/usr/local/lib/libopencv_videoio.so.4.5.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ldd/cvbridge_py/devel/.private/image_geometry/lib;/home/ldd/cvbridge_py/install/lib;/home/ldd/realsense_ros/devel/lib;/home/ldd/catkin_ws/devel/lib;/opt/ros/melodic/lib)
